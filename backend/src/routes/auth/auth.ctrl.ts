...
export const sendAuthEmail = async (req: Request, res: Response): Promise<any> => {
    type BodySchema = {
        email: string,
    };
...
export const localRegister = async (req: Request, res: Response): Promise<any> => {
    type BodySchema = {
...
export const socialRegister = async (req: Request, res: Response): Promise<any> => {
    type BodySchema = {
        accessToken: string,
        displayName: string,
        username: string,
...
export const verifySocial = async (req: Request, res: Response): Promise<any> => {
    type BodySchema = {
        accessToken: string,
    };
