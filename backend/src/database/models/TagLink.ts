...
TagLink.statics.addTagsToPin = async function(pinId: string, tags: string[]): Promise<any> {
...
TagLink.statics.removeTagsPin = async function(pinId: string, tags: string[]): Promise<any> {
    if (tags.length === 0) return;
