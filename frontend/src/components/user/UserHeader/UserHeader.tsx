            ...
            <div className={cx('user-info')}>
                <section className={cx('top')}>
                    <div className={cx('wrapper')}>
                        <Button className={cx('profile-setting')} theme="outline" onClick={() => console.log('test')}>
                            작성하기
                        </Button>
                        <Button className={cx('profile-setting')} theme="outline" onClick={() => console.log('test')}>
                                프로필 편집
                        ...
                        <React.Fragment>
                            {   
                                userId === id ? null : (
                                    follow ? (
                                        <Button className={cx("subscribe")} theme="default" onClick={() => console.log('test')}>
                                            구독중
                                        </Button>
                                    ) : (
                                        <Button className={cx("subscribe")} theme="outline" onClick={() => console.log('test')}>
                                            구독하기
                                        </Button>
                                    )
                                )
