...
export const commonCreators = {
  ...
  changeInputProfile: createAction(
    CHANGE_INPUT_PROFILE,
    (payload: ChangeInputProfilePayload) => payload
  ),
  ...
  createNotice: createPromiseThunk(
    CREATE_NOTICE,
    commonAPI.createNoticeRoomAPI
  ),
  sendMessage: createAction(SEND_MESSAGE, commonAPI.sendMessageNoticeAPI),
};
...
type GetProfileAction = GenericResponseAction<
  ...
  string
>;
type ChangeInputProfileAction = ReturnType<
  typeof commonCreators.changeInputProfile
>;
type SearchDataAction = GenericResponseAction<
  ...
  string
>;
type PrefetchListAction = GenericResponseAction<
  { Data: any[]; next: string },
  string
>;
type RevealPrefetchedAction = ReturnType<
  typeof commonCreators.revealPrefetched
>;
type ChangeSearchValueAction = ReturnType<
  typeof commonCreators.changeSearchValue
>;
type CreateNoticeAction = GenericResponseAction<
  {
    noticeWithData: {
      noticeId: string;
      creator: {
