...
export const followsCreators = {
  ...
  getFollowerList: createPromiseThunk(
    GET_FOLLOWER_LIST,
    followAPI.getFollowerAPI
  ),
  getFollowingList: createPromiseThunk(
    GET_FOLLOWING_LIST,
    followAPI.getFollowingAPI
  ),
};
...
type GetFollowListAction = GenericResponseAction<
