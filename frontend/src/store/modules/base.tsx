...
export const baseCreators = {
  setHeaderVisibility: createAction(
  ...
  searchFullscreenLoader: createAction(
    SEARCH_FULLSCREEN_LOADER,
    (visible: boolean) => visible
  ),
...
type SearchFullscreenLoaderAction = ReturnType<
  typeof baseCreators.searchFullscreenLoader
>;
type SetHeaderVisibilityAction = ReturnType<
  typeof baseCreators.setHeaderVisibility
>;
type SetFullscreenLoaderAction = ReturnType<
  typeof baseCreators.setFullscreenLoader
>;
...
export default handleActions<BaseState, any>(
  {
    ...
    [SEARCH_FULLSCREEN_LOADER]: (
      state,
      action: SearchFullscreenLoaderAction
    ) => {
      return produce(state, draft => {
        if (action.payload === undefined) return;
