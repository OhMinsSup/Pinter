...
import { actionsCreators as tagActions, TagDataSubState } from '../../store/modules/tag';
import TagItemList from '../../components/tags/TagItemList';
...
class TagItemListContainer extends React.Component<TagItemListContainerProps> {
    ...
    public render() {
        ...
        return (
            <TagItemList tags={tags} onSelectTag={onSelectTag}/>
        );
    }
}
