...
type UserSaveCardProps = StateProps & DispatchProps & OwnProps;

class UserSaveCard extends React.Component<UserSaveCardProps> {
    ...
    public prefetch = async () => {
        ...
        try {
            await ListActions.prefetchSaveList(next);
        } catch (e) {
            console.log(e);
        }
    }
    ...
    public initialize = async () => {
        ...
        try {
            await ListActions.getSavesList(displayName);
        } catch (e) {
            console.log(e);
        }
    }
...
const mapStateToProps = ({ list }: StoreState) => ({
    pins: list.locker.pins,
    prefetched: list.locker.prefetched,
    next: list.locker.next,
    loading: list.locker.loading,
});
